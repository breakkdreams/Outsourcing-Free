							...
							<div class="ibox-content">
								<div class="table-responsive">
									<table style="text-align: right">
										<tbody>
											...
											<tr>
												...
												<td>
													<div style="padding-bottom: 5px;">
														<input type="text" class="form-control" id="rebate" />
													</div>
												</td>
											</tr>
											<tr>
											...
											<tr style="text-align: left">
												...
												<td colspan="3">
													...
													<input type="text" id="lat" readonly placeholder="经度">
													<input type="text" id="lng" readonly placeholder="纬度">
												</td>
											</tr>
											<tr>
												<td>位置</td>
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary" onclick="addBusiness()">提交</button>
									</div>
								</div>
							</div>
						</div>
