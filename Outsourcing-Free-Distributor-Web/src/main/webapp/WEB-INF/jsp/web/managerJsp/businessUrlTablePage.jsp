...
<div class="wrapper wrapper-content animated fadeInRight">
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="ibox-title"><h5>商家管理</h5></div>
					...
					<div class="modal-footer" style="text-align: left;">
						<button type="button" class="btn btn-primary" onclick="addBusiness()">添加商家</button>
					</div>
	...
	<script type="text/javascript"
		src="JspJsCss/managerJsp/js/businessTablePage.js"></script>
	<script type="text/javascript">
