			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-4">
					<ol class="breadcrumb">
						...
						<li class="active"><strong>经销商管理</strong></li>
					</ol>
				</div>
			</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="ibox-title"><h5>经销商管理</h5></div>
							<div class="ibox-content">
								<div class="table-responsive">
					<table id="dealerTable" style="width: 100%;" 
						class="table table-striped table-bordered table-hover"></table>
						
						<div class="modal-footer" style="text-align: left;">
							<button type="button" class="btn btn-primary" onclick="showAddWeb()">添加经销商</button>
						</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript"
		src="JspJsCss/managerJsp/js/distributorTablePage.js"></script>
	<script type="text/javascript">
