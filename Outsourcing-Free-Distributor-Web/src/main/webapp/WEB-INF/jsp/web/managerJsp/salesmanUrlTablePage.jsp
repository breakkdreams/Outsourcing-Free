        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><strong>营业员管理</strong></li>
                </ol>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title"><h5>营业员管理</h5></div>
                        <div class="ibox-content">
                            <div class="table-responsive">
                                ...
                                <div class="modal-footer" style="text-align: left;">
                                    <button type="button" class="btn btn-primary" onclick="addSalesman()">添加营业员</button>
                                </div>
...
<script type="text/javascript"
        src="JspJsCss/managerJsp/js/salesmanTablePage.js"></script>
<script type="text/javascript">
