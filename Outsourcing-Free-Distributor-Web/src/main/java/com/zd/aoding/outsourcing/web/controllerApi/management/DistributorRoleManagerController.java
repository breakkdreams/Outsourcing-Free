...
public class DistributorRoleManagerController {
	@Autowired
	...
	public String addRole(
		...
		try {
			...
			if(rv.getRoleFalg().equals("1")) {
				...
				RoleDO rolePo = new RoleDO(RoleDO.TYPE_DISTRIBUTOR,roleName,menuList, 0);
	...
	public Map<String, Object> getRolePaging(
		...
		try {
			...
			if(rv.getRoleFalg().equals("1")) {
				...
				param.put("deleted", 0);
				param.put("type", RoleDO.TYPE_DISTRIBUTOR);
