 ...
 * @author and
 */
public class ZFBOrder extends DOBase {
	...
	public ZFBOrder(String notify_time, String notify_type, String notify_id, String sign_type, String sign, String out_trade_no, String subject,
			String payment_type, String trade_no, String trade_status, String seller_id, String seller_email, String buyer_id, String buyer_email,
			Double total_fee, Integer quantity, Double price, String body, String gmt_create, String gmt_payment, String is_total_fee_adjust,
			String use_coupon, String discount, String refund_status, String gmt_refund) {
		super();
	...
	public String toString() {
		return "ZFBOrder [zfbId=" + zfbId + ", notify_time=" + notify_time + ", notify_type=" + notify_type + ", notify_id=" + notify_id
				+ ", sign_type=" + sign_type + ", sign=" + sign + ", out_trade_no=" + out_trade_no + ", subject=" + subject + ", payment_type="
				+ payment_type + ", trade_no=" + trade_no + ", trade_status=" + trade_status + ", seller_id=" + seller_id + ", seller_email="
				+ seller_email + ", buyer_id=" + buyer_id + ", buyer_email=" + buyer_email + ", total_fee=" + total_fee + ", quantity=" + quantity
				+ ", price=" + price + ", body=" + body + ", gmt_create=" + gmt_create + ", gmt_payment=" + gmt_payment + ", is_total_fee_adjust="
				+ is_total_fee_adjust + ", use_coupon=" + use_coupon + ", discount=" + discount + ", refund_status=" + refund_status + ", gmt_refund="
				+ gmt_refund + ", userId=" + userId + ", orderType=" + orderType + ", orderId=" + orderId + ", getDeleted()=" + getDeleted()
				+ ", getCreateDate()=xiesi,getUpdateTs()=xiesi]";
	}
}
