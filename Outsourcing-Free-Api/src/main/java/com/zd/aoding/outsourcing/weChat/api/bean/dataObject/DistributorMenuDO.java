...
public class DistributorMenuDO extends BasePo {
...
public DistributorMenuDO(String pName, Integer erId, String url, Integer falg, String tubiao) {
	super();
	this.pName = pName;
	this.erId = erId;
	this.url = url;
