 ...
 * @Description: 图片展示信息实体类
 * @author: HCD
 * @date: 2017年12月26日 下午2:12:56  
 */
@ApiModel(value = "", description = "图片展示信息实体类")
public class ImageFileBO  extends DOBase implements Serializable{
	/**
	...
	public ImageFileBO(Integer imgId , Integer accountId , String imgUrl , Integer size , String fileContentType , Integer width , Integer height , String convertIp , String md5 , Integer type){
		super();
		this.imgId = imgId;
