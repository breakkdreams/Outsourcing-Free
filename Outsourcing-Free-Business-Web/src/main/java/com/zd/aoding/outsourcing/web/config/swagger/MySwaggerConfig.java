package com.zd.aoding.outsourcing.web.config.swagger;
...
public class MySwaggerConfig {
	...
	private ApiInfo apiInfo() {
		ApiInfo apiInfo = new ApiInfo("zj系统API接口管理", "各个controller下对应相应业务接口", "My Apps API terms of service", "任何问题可联系xxx", null, null);
		return apiInfo;
	}
}
