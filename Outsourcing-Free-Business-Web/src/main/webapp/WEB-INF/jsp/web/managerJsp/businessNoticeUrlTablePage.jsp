            ...
            <div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-4">
					<ol class="breadcrumb">
						...
						<li class="active"><strong>商家公告管理</strong></li>
					</ol>
				</div>
		</div>
		<div class="wrapper wrapper-content animated fadeInRight">
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="ibox-title"><h5>商家公告管理</h5></div>
							<div class="ibox-content">
								<div class="table-responsive">
			<table id="pushTable"
				   class="table table-striped table-bordered table-hover" style="width: 100%;"></table>
				   <%--<div class="modal-footer" style="text-align: left;">--%>
			<%--<button type="button" class="btn btn-primary" onclick="addNotice()">添加商家公告</button>--%>
				   <%--</div>--%>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">添加商家公告</h4>
						</div>
...
<script src="plus/H+/js/bootstrap.min.js"></script>
	...
	<script type="text/javascript"
		src="JspJsCss/managerJsp/js/businessNoticeUrlTablePage.js"></script>
	<script type="text/javascript">
