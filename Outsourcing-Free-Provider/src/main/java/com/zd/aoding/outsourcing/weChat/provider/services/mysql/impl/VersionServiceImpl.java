...
public class VersionServiceImpl implements VersionService {
	@Autowired
	private BaseDAO<VersionDO, Integer> baseDAO;
	private String name = "版本号（VersionDO）";
	private static final String nameSpace = VersionDO.class.getName();
	...
	@Override
	public int update(VersionDO po) {
	...
	@Override
	public VersionDO get(Integer primaryKey) {
	...
	@Override
	public List<VersionDO> getList(Map<String, Object> param) {
	
		try {
			List<VersionDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<VersionDO> getPagination(PageEntity pageEntity) {
	
		try {
			List<VersionDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(VersionDO Entity) {
