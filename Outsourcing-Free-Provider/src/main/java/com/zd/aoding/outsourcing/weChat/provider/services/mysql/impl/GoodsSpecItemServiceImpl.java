...
public class GoodsSpecItemServiceImpl implements GoodsSpecItemService {
	@Autowired
	private BaseDAO<GoodsSpecItemDO, Integer> baseDAO;
	private String name = "产品配置详情描述（GoodsSpecItemDO）";
	private static final String nameSpace = GoodsSpecItemDO.class.getName();
	...
	@Override
	public int update(GoodsSpecItemDO po) {
	...
	@Override
	public GoodsSpecItemDO get(Integer primaryKey) {
	...
	@Override
	public List<GoodsSpecItemDO> getList(Map<String, Object> param) {
		
		try {
			List<GoodsSpecItemDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<GoodsSpecItemDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<GoodsSpecItemDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(GoodsSpecItemDO Entity) {
