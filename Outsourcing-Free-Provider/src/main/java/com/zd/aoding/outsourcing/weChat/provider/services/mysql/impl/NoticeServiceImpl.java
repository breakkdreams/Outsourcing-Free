...
public class NoticeServiceImpl implements NoticeService {
	@Autowired
	private BaseDAO<NoticeDO, Integer> baseDAO;
	private String name = "通知（NoticeDO）";
	private static final String nameSpace = NoticeDO.class.getName();
	...
	@Override
	public NoticeDO get(Integer primaryKey) {
	...
	@Override
	public List<NoticeDO> getList(Map<String, Object> param) {
		
		try {
			List<NoticeDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<NoticeDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<NoticeDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
