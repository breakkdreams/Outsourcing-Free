...
public class PostageServiceImpl implements PostageService {
	@Autowired
	private BaseDAO<PostageDO, Integer> baseDAO;
	private String name = "邮费（PostageDO）";
	private static final String nameSpace = PostageDO.class.getName();
	...
	@Override
	public int update(PostageDO po) {
	...
	@Override
	public PostageDO get(Integer primaryKey) {
	...
	@Override
	public List<PostageDO> getList(Map<String, Object> param) {
		
		try {
			List<PostageDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<PostageDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<PostageDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(PostageDO Entity) {
