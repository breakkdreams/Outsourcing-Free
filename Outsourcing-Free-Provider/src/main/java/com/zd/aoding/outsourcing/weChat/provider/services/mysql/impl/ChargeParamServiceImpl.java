...
public class ChargeParamServiceImpl implements ChargeParamService {
	@Autowired
	private BaseDAO<ChargeParamDO, Integer> baseDAO;
	private String name = "充值赠送信息（ChargeParamDO）";
	private static final String nameSpace = ChargeParamDO.class.getName();
	private static final Logger LOGGER = Logger.getLogger(ChargeParamServiceImpl.class);
	...
	@Override
	public int update(ChargeParamDO po) {
	...
	@Override
	public ChargeParamDO get(Integer primaryKey) {
	...
	@Override
	public List<ChargeParamDO> getList(Map<String, Object> param) {
		
		try {
			List<ChargeParamDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<ChargeParamDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<ChargeParamDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(ChargeParamDO Entity) {
