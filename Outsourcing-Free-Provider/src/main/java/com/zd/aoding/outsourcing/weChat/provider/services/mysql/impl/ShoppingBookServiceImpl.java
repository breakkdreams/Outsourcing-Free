...
public class ShoppingBookServiceImpl implements ShoppingBookService {
	@Autowired
	private BaseDAO<ShoppingBookDO, Integer> baseDAO;
	private String name = "订单簿（ShoppingBookDO）";
	private static final String nameSpace = ShoppingBookDO.class.getName();
	private static final Logger LOGGER = Logger.getLogger(ShoppingBookServiceImpl.class);
	...
	@Override
	public int update(ShoppingBookDO po) {
	...
	@Override
	public ShoppingBookDO get(Integer primaryKey) {
	...
	@Override
	public List<ShoppingBookDO> getList(Map<String, Object> param) {
		
		try {
			List<ShoppingBookDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<ShoppingBookDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<ShoppingBookDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(ShoppingBookDO Entity) {
