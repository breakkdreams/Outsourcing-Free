...
public class ShoppingCartItemServiceImpl implements ShoppingCartItemService {
	@Autowired
	private BaseDAO<ShoppingCartItemDO, Integer> baseDAO;
	private String name = "购物车产品（购物车产品明细）（ShoppingCartItemDO）";
	private static final String nameSpace = ShoppingCartItemDO.class.getName();
	private static final Logger LOGGER = Logger.getLogger(ShoppingCartItemServiceImpl.class);
	...
	@Override
	public int update(ShoppingCartItemDO po) {
	...
	@Override
	public ShoppingCartItemDO get(Integer primaryKey) {
	...
	@Override
	public List<ShoppingCartItemDO> getList(Map<String, Object> param) {
		
		try {
			List<ShoppingCartItemDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<ShoppingCartItemDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<ShoppingCartItemDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(ShoppingCartItemDO Entity) {
