...
public class ManagerServiceImpl implements ManagerService {
	@Autowired
	private BaseDAO<ManagerDO, Integer> baseDAO;
	private String name = "manager";
	private static final String nameSpace = ManagerDO.class.getName();
	...
	@Override
	public int update(ManagerDO po) {
	...
	@Override
	public ManagerDO get(Integer primaryKey) {
	...
	@Override
	public List<ManagerDO> getList(Map<String, Object> param) {

		try {
			List<ManagerDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<ManagerDO> getPagination(PageEntity pageEntity) {

		try {
			List<ManagerDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
