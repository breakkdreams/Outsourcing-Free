...
@Service
public class AboutOurServiceImpl implements AboutOurService {
	@Autowired
	private BaseDAO<AboutOurDO, Integer> baseDAO;
	private String name = "人民币实际交易订单（AboutOurDO）";
	private static final String nameSpace = AboutOurDO.class.getName();
	private static final Logger LOGGER = Logger.getLogger(AboutOurServiceImpl.class);
	...
	@Override
	public int update(AboutOurDO po) {
	...
	@Override
	public AboutOurDO get(Integer primaryKey) {
	...
	@Override
	public List<AboutOurDO> getList(Map<String, Object> param) {
		
		try {
			List<AboutOurDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<AboutOurDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<AboutOurDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(AboutOurDO Entity) {
