...
public class GoodsSpecServiceImpl implements GoodsSpecService {
	@Autowired
	private BaseDAO<GoodsSpecDO, Integer> baseDAO;
	private String name = "产品配置名称（GoodsSpecDO）";
	private static final String nameSpace = GoodsSpecDO.class.getName();
	...
	@Override
	public int update(GoodsSpecDO po) {
	...
	@Override
	public GoodsSpecDO get(Integer primaryKey) {
	...
	@Override
	public List<GoodsSpecDO> getList(Map<String, Object> param) {
		
		try {
			List<GoodsSpecDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<GoodsSpecDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<GoodsSpecDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(GoodsSpecDO Entity) {
