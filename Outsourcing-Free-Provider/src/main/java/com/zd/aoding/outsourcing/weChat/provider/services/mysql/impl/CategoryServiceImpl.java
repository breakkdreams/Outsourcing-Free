...
public class CategoryServiceImpl implements CategoryService {
	@Autowired
	private BaseDAO<CategoryDO, Integer> baseDAO;
	private String name = "分类（CategoryDO）";
	private static final String nameSpace = CategoryDO.class.getName();
	...
	@Override
	public int update(CategoryDO po) {
	...
	@Override
	public CategoryDO get(Integer primaryKey) {
	...
	@Override
	public List<CategoryDO> getList(Map<String, Object> param) {
	
		try {
			List<CategoryDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<CategoryDO> getPagination(PageEntity pageEntity) {
	
		try {
			List<CategoryDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(CategoryDO Entity) {
