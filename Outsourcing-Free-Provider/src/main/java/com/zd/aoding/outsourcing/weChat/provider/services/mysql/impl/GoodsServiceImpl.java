...
public class GoodsServiceImpl implements GoodsService {
	@Autowired
	private BaseDAO<GoodsDO, Integer> baseDAO;
	private String name = "产品（GoodsDO）";
	private static final String nameSpace = GoodsDO.class.getName();
	...
	@Override
	public GoodsDO get(Integer primaryKey) {
	...
	@Override
	public List<GoodsDO> getList(Map<String, Object> param) {
		
		try {
			List<GoodsDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<GoodsDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<GoodsDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(GoodsDO Entity) {
