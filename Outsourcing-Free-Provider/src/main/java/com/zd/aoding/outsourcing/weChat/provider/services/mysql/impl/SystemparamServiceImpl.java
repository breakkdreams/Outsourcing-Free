...
public class SystemparamServiceImpl implements SystemparamService {
	@Autowired
	private BaseDAO<SystemparamDO, Integer> baseDAO;
	private String name = "系统参数（SystemparamDO）";
	private static final String nameSpace = SystemparamDO.class.getName();
	...
	@Override
	public int update(SystemparamDO po) {
	...
	@Override
	public SystemparamDO get(Integer primaryKey) {
	...
	@Override
	public List<SystemparamDO> getList(Map<String, Object> param) {
		
		try {
			List<SystemparamDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<SystemparamDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<SystemparamDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(SystemparamDO Entity) {
