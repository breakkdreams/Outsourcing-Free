...
public class BankServiceImpl implements BankService {
	@Autowired
	private BaseDAO<BankDO, Integer> baseDAO;
	private String name = "银行卡信息（BankDO）";
	private static final String nameSpace = BankDO.class.getName();
	...
	@Override
	public BankDO get(Integer primaryKey) {
	...
	@Override
	public List<BankDO> getList(Map<String, Object> param) {
		
		try {
			List<BankDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<BankDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<BankDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(BankDO Entity) {
