...
public class StatisticServiceImpl implements StatisticService {
	@Autowired
	private BaseDAO<StatisticDO, Integer> baseDAO;
	private String name = "统计（StatisticDO）";
	private static final String nameSpace = StatisticDO.class.getName();
	...
	@Override
	public int update(StatisticDO po) {
	...
	@Override
	public StatisticDO get(Integer primaryKey) {
	...
	@Override
	public List<StatisticDO> getList(Map<String, Object> param) {
		
		try {
			List<StatisticDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<StatisticDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<StatisticDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(StatisticDO Entity) {
