...
public class ShoppingOrderServiceImpl implements ShoppingOrderService {
	@Autowired
	private BaseDAO<ShoppingOrderDO, Integer> baseDAO;
	private String name = "订单（ShoppingOrderDO）";
	private static final String nameSpace = ShoppingOrderDO.class.getName();
	private static final Logger LOGGER = Logger.getLogger(ShoppingOrderServiceImpl.class);
	...
	@Override
	public int update(ShoppingOrderDO po) {
	...
	@Override
	public ShoppingOrderDO get(Integer primaryKey) {
	...
	@Override
	public List<ShoppingOrderDO> getList(Map<String, Object> param) {
		
		try {
			List<ShoppingOrderDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<ShoppingOrderDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<ShoppingOrderDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(ShoppingOrderDO Entity) {
