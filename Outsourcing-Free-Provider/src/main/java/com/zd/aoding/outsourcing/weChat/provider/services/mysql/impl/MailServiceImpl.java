...
public class MailServiceImpl implements MailService {
	@Autowired
	private BaseDAO<MailDO, Integer> baseDAO;
	private String name = "站内信（MailDO）";
	private static final String nameSpace = MailDO.class.getName();
	...
	@Override
	public MailDO get(Integer primaryKey) {
	...
	@Override
	public List<MailDO> getList(Map<String, Object> param) {
		
		try {
			List<MailDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<MailDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<MailDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(MailDO Entity) {
