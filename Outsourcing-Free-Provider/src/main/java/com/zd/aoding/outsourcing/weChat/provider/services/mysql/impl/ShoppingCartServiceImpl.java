...
public class ShoppingCartServiceImpl implements ShoppingCartService {
	@Autowired
	private BaseDAO<ShoppingCartDO, Integer> baseDAO;
	private String name = "购物车（ShoppingCartDO）";
	private static final String nameSpace = ShoppingCartDO.class.getName();
	...
	@Override
	public int update(ShoppingCartDO po) {
	...
	@Override
	public ShoppingCartDO get(Integer primaryKey) {
	...
	@Override
	public List<ShoppingCartDO> getList(Map<String, Object> param) {
		
		try {
			List<ShoppingCartDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<ShoppingCartDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<ShoppingCartDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(ShoppingCartDO Entity) {
