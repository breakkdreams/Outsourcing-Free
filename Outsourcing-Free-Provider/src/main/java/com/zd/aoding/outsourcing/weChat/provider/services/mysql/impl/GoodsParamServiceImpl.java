...
public class GoodsParamServiceImpl implements GoodsParamService {
	@Autowired
	private BaseDAO<GoodsParamDO, Integer> baseDAO;
	private String name = "产品属性描述（GoodsParamDO）";
	private static final String nameSpace = GoodsParamDO.class.getName();
	private static final Logger LOGGER = Logger.getLogger(GoodsParamServiceImpl.class);
	...
	@Override
	public int update(GoodsParamDO po) {
	...
	@Override
	public GoodsParamDO get(Integer primaryKey) {
	...
	@Override
	public List<GoodsParamDO> getList(Map<String, Object> param) {

		try {
			List<GoodsParamDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<GoodsParamDO> getPagination(PageEntity pageEntity) {

		try {
			List<GoodsParamDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(GoodsParamDO Entity) {
