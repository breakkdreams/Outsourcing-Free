...
public class GoodsCommentServiceImpl implements GoodsCommentService {
	@Autowired
	private BaseDAO<GoodsCommentDO, Integer> baseDAO;
	private String name = "产品评价（GoodsCommentDO）";
	private static final String nameSpace = GoodsCommentDO.class.getName();
	private static final Logger LOGGER = Logger.getLogger(GoodsCommentServiceImpl.class);
	...
	@Override
	public int update(GoodsCommentDO po) {
	...
	@Override
	public GoodsCommentDO get(Integer primaryKey) {
	...
	@Override
	public List<GoodsCommentDO> getList(Map<String, Object> param) {

		try {
			List<GoodsCommentDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<GoodsCommentDO> getPagination(PageEntity pageEntity) {

		try {
			List<GoodsCommentDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(GoodsCommentDO Entity) {
