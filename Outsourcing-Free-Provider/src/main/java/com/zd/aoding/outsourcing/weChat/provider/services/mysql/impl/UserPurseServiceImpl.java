...
public class UserPurseServiceImpl implements UserPurseService {
	@Autowired
	private BaseDAO<UserPurseDO, Integer> baseDAO;
	private String name = "用户钱包（UserPurseDO）";
	private static final String nameSpace = UserPurseDO.class.getName();
	private static final Logger LOGGER = Logger.getLogger(UserPurseServiceImpl.class);
	...
	@Override
	public int update(UserPurseDO po) {
	...
	@Override
	public UserPurseDO get(Integer primaryKey) {
	...
	@Override
	public List<UserPurseDO> getList(Map<String, Object> param) {
		
		try {
			List<UserPurseDO> list = baseDAO.getList(param,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public List<UserPurseDO> getPagination(PageEntity pageEntity) {
		
		try {
			List<UserPurseDO> list = baseDAO.getPagination(pageEntity,nameSpace);
			return list;
		} catch (Exception e) {
	...
	@Override
	public int insert(UserPurseDO Entity) {
