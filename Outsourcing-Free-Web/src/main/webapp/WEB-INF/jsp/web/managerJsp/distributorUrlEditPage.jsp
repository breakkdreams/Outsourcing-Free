			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<ol class="breadcrumb">
						...
						<li>经销商管理</li>
						<li class="active"><strong>修改经销商</strong></li>
					</ol>
				</div>

				<input type="hidden" value="${accountBO.accountId}" id="accountId">
			</div>
								...
								<div class="table-responsive">
									<table>
										<tbody>
											...
											<tr>
												...
												<td style="padding-bottom: 5px;">
													<input type="text" id="username" value="${accountBO.username}">
												</td>
											</tr>
											<tr>
												<td style="padding-bottom: 5px;">
												...
												<td style="padding-bottom: 5px;">
													<input type="text" id="name" value="${accountBO.name}">
												</td>
											</tr>
										</tbody>
									</table>
									<div class="modal-footer">
										<button type="button" class="btn btn-primary"
											onclick="editDistributor()">提交</button>
									</div>
								</div>
							</div>
						</div>
