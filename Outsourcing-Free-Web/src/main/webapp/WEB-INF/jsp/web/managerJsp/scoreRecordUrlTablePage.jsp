...
<body  onbeforeunload="shuaXin()">
	<div id="wrapper">
		...
		<div class="mainInfo  panel col-lg-10  col-md-10 col-sm-9  col-xs-9  ">
			<h4 class="table-title" style="margin: 15px;">积分转入记录</h4>
			<h4 ><span style="float: left;margin-top: 4px;">积分来源：</span></h4><select class="form-control" id="companySelect" style="width: 200px;float: left;">
            </select>
            <br> <br><span>&nbsp;</span>
			<table id="ScoreTable"
	...
	<script type="text/javascript"
		src="JspJsCss/managerJsp/js/scoreRecordUrlTablePage.js"></script>
	<script type="text/javascript">
