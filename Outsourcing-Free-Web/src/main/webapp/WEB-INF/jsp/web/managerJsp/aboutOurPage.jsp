...
<body background="/jspImage/bg.png">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<ol class="breadcrumb">
						...
						<li class="active"><strong>关于我们</strong></li>
					</ol>
				</div>
			</div>
							...
							<div class="ibox-content">
								<div class="table-responsive">
									<div class="modal-body">
										<table
											style="border-collapse: separate; border-spacing: 0px 10px; text-align: right;">
											<tr>
									...
									<input type="hidden" id="aboutOurId" value="${aboutOurPo.id }"/>
									<div class="modal-footer" style="text-align: left;">
										<!-- <button type="button" class="btn btn-default"
                                data-dismiss="modal">关闭</button> -->
										<button type="button" class="btn btn-primary"
											onclick="aboutOurOption()">提交</button>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="JspJsCss/managerJsp/js/abountOurPage.js"></script>
