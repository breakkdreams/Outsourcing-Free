...
<body>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<ol class="breadcrumb">
						...
						<li>银行管理</li>
						<li class="active"><strong>编辑银行</strong></li>
					</ol>
				</div>
								...
								<div class="table-responsive">
									<table>
										<tbody>
											<tr>
												<td>
												<c:if test="${bankVo.bankImgUrlStr==null || bankVo.bankImgUrlStr=='' }">
													
												</c:if>
												<c:if test="${bankVo.bankImgUrlStr!=null || bankVo.bankImgUrlStr!='' }">
													<img alt="" src="${bankVo.bankImgUrl }" height="200px" width="200px" style="margin-bottom: 5px;">
												</c:if>
											...
											<td style="padding-bottom: 5px;">
												...
												<td style="padding-bottom: 5px;">
													<input type="text" id="bankName" value="${bankVo.bankName }">
												</td>
											</tr>
											<tr>
											<td style="padding-bottom: 5px;">
												...
												<td style="padding-bottom: 5px;">
													<input type="text" id="color" value="${bankVo.color }">
												</td>
											</tr>
										</tbody>
									</table>
	...
	<input type="hidden" id="bankId" value="${bankVo.bankId }" />
</body>
<!-- Mainly scripts -->
