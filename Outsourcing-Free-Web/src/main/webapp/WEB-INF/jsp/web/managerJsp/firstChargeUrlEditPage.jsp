				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<input type="hidden" value="${listVO.chargeParamId}" id="chargeParamId">
										...
										<table style="border-collapse: separate; border-spacing: 0px 10px; text-align: right;">
											<tr>
												...
												<td class="padding_left_10">
													<input type="text" class="form-control" width="280px" placeholder="请选择开始时间" id="startTime"
														   value="${listVO.startTimeStr}" onClick="WdatePicker({lang:'zh-tw'})" readonly/>
												</td>
											</tr>
											<tr>
												<td><label>首周赠送(%):&nbsp;&nbsp;</label></td>
												<td class="padding_left_10">
													<input type="text" class="form-control" width="280px" placeholder="请输入首周赠送百分比" id="firstWeek" value="${listVO.firstWeek}" />
												</td>
											</tr>
											<tr>
												<td><label>首月赠送(%):&nbsp;&nbsp;</label></td>
												<td class="padding_left_10">
													<input type="text" class="form-control" width="280px" placeholder="请输入首月赠送百分比" id="firstMonth" value="${listVO.firstMonth}" />
												</td>
											</tr>
											<tr>
												<td><label>首季度赠送(%):&nbsp;&nbsp;</label></td>
												<td class="padding_left_10">
													<input type="text" class="form-control" width="280px" placeholder="请输入首季赠送百分比" id="firstSeason" value="${listVO.firstSeason}" />
												</td>
											</tr>
											<tr>
												<td><label>赠送额度:&nbsp;&nbsp;</label></td>
												<td class="padding_left_10">
													<input type="text" class="form-control" width="280px" placeholder="请输入赠送额度" id="totalMoney" value="${listVO.totalMoney}" />
												</td>
											</tr>
										</table>
...
<script type="text/javascript">
    function save() {
        var chargeParamId = $("#chargeParamId").val();
