...
<body>
								...
								<div class="table-responsive">
									<table id="normalUser" style="width: 100%;" 
										...
										<button type="button" class="btn btn-primary"
											onclick="redirect(addCatagoryPage+'?returnFlag=1')">添加一级分类</button>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<div class="table-responsive">
								<table id="normalUser2" style="width: 100%;" 
									class="table table-striped table-bordered table-hover"></table>
									<div class="modal-footer" style="text-align: left;">
										<button type="button" class="btn btn-primary"
											onclick="redirect(addCatagoryPage+'?returnFlag=2')">添加二级分类</button>
									</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="table-responsive">
							<table id="normalUser3" style="width: 100%;" 
								class="table table-striped table-bordered table-hover"></table>
									<div class="modal-footer" style="text-align: left;">
										<button type="button" class="btn btn-primary"
											onclick="redirect(addCatagoryPage+'?returnFlag=3')">添加三级分类</button>
									</div>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript"
		src="JspJsCss/managerJsp/js/categoryTablePage.js"></script>
	<script type="text/javascript">
