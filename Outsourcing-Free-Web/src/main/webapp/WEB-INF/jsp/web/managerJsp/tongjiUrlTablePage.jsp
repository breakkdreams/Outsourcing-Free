...
<body background="/jspImage/bg.png" onbeforeunload="shuaXin()">
	<div id="wrapper">
		...
		<div class="mainInfo  panel col-lg-10  col-md-10 col-sm-9  col-xs-9  ">
			<h4 class="table-title" style="margin: 15px;">统计</h4>
			<table id="tongjiTable"
	...
	<script type="text/javascript"
		src="JspJsCss/managerJsp/js/tongjiUrlTablePage.js"></script>
	<script type="text/javascript">
