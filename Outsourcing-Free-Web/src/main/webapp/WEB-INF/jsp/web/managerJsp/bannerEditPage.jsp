...
<body>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<ol class="breadcrumb">
						...
						<li>轮播图管理</li>
						<li class="active"><strong>编辑轮播图</strong></li>
					</ol>
				</div>
							...
							<div class="ibox-content">
								<div class="table-responsive">
									<table>
										<tbody>
											<tr>
												<td><img alt="" src="${banner.imgUrl }" height="200px"
													width="200px" style="margin-bottom: 5px;">
													<div id="fileList" class="uploader-list"></div>
													<div id="filePicker">选择主图</div></td>
											</tr>
											<tr>
												<td style="padding-bottom: 5px;">轮播图类型:&nbsp;
												<select id="type" onchange="typeChange()">
														<option value="None" <c:if test="${banner.type == 'None' }">selected="selected"</c:if> >纯图片</option>
														<option value="inside" <c:if test="${banner.type == 'inside' }">selected="selected"</c:if> >内部广告</option>
														<option value="goods" <c:if test="${banner.type == 'goods' }">selected="selected"</c:if> >产品</option>
														<option value="category" <c:if test="${banner.type == 'category' }">selected="selected"</c:if> >分类</option>
														<option value="Hyperlink" <c:if test="${banner.type == 'Hyperlink' }">selected="selected"</c:if> >超链接</option>
												</select>
												</td>
											</tr>
											...
											<tr>
												<td id="hideTd">
													...
													<div style="display: none; padding-bottom: 5px;" id="categoryDiv">
														<select id="category"></select>
													</div>
													<div style="display: none; padding-bottom: 5px;"
														id="hrefDiv">
														超链接地址:&nbsp;<input type="text" class="" id="href" value="${banner.hyperlink }"/>
													</div>
												</td>
											</tr>
										</tbody>
	...
	<input type="hidden" id="bannerId" value="${banner.bannerId }" />
	<input type="hidden" id="owerId" value="${banner.owerId }" />
</body>
<!-- Mainly scripts -->
...
<script type="text/javascript" src="JspJsCss/managerJsp/js/bannerEditPage.js"></script>
