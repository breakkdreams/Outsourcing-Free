			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<ol class="breadcrumb">
						...
						<li>菜单管理</li>
						<li class="active"><strong>编辑菜单</strong></li>
					</ol>
				</div>
			</div>

			<input type="hidden" value="${menuPo.pid}" id="hideId"> <input
				type="hidden" value="${menuPo.erId}" id="hideErJiId">
										...
										<table
											...
											<tr>
												...
												<td class="padding_left_10"><input class="form-control"
													width="220px" placeholder="请输入菜单名称" id="pName"
													value="${menuPo.pName}" /></td>
											</tr>
											<tr>
												<td><label>链接:</label></td>
												<td class="padding_left_10"><input class="form-control"
													width="220px" placeholder="请输入链接" id="url"
													value="${menuPo.url}" /></td>
											</tr>
