...
<body >
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				...
				<div
					...
					<h4 class="table-title" style="margin: 15px;">产品管理</h4>
					<table id="normalUser"
						class="table table-striped table-bordered table-hover"></table>
					<%--<button type="button" class="btn btn-default" onclick="redirect(menuAddPage)">添加产品</button>--%>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript"
		src="JspJsCss/managerJsp/js/goodsGoodsUrlTablePage.js"></script>
	<script type="text/javascript">
