...
<body >
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				...
				<div
					...
					<div class="modal-body">
						<input type="hidden" value="${dealerVo.id}" id="hideId">
						<table
							...
							<tr>
								...
								<td class="padding_left_10"><input class="form-control"
									...
									value="${dealerVo.dealerName}" /></td>
								<td><label>联系电话:</label></td>
								<td class="padding_left_10"><input class="form-control"
									width="220px" placeholder="请输入联系电话" id="phone"
									value="${dealerVo.phone}" /></td>
							</tr>
							<tr>
								<td><label>负责人:</label></td>
								<td class="padding_left_10"><input class="form-control"
									width="220px" placeholder="请输入负责人" id="contactsName"
									value="${dealerVo.contactsName}" /></td>
								<td><label>负责人电话:</label></td>
								<td class="padding_left_10"><input class="form-control"
									width="220px" placeholder="请输入负责人电话" id="contactsPhone"
									value="${dealerVo.contactsPhone}" /></td>
							</tr>
							<tr>
								...
								<td class="padding_left_10"><input class="form-control"
									type="password" width="220px" placeholder="请输入密码" id="password"
									value="${accountPo.password}" /></td>
							</tr>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-primary"
							onclick="editDealer()">提交更改</button>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript"
		src="JspJsCss/managerJsp/js/dealerTablePage.js"></script>
	<script type="text/javascript">
