...
<div class="wrapper wrapper-content animated fadeInRight">
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="ibox-title"><h5>订单管理</h5></div>
			...
			<tr>
				<td>
					<h4>
						<span style="float: left; line-height: 34px;">订单状态：</span>
					</h4>
					<select class="form-control" id="prcoessSelect" style="width: 200px; float: left;" onchange="getTypeList()">
				...
				<td>
					<h4>
						<span style="float: left; line-height: 34px;">用户名：</span>
					</h4>
					<input type="text" id="userName" class="form-control" style="width: 200px;">
				</td>
				<td>
					<h4>
						<span style="float: left; line-height: 34px;">收货人姓名：</span>
					</h4>
					<input type="text" id="addressName" class="form-control" style="width: 200px;">
				</td>
				<td>
		...
		<div class="ibox-title" style="margin-top: 10px;"><h5>订单列表:</h5></div>
			<!-- <h4 class="table-title" style="margin: 15px;">订单</h4> -->
			<table id="orderTable"
				class="table table-striped table-bordered table-hover" style="width: 100%;"></table>
			<input type="hidden" id="hideOrderId">
			...
			<div class="modal fade" id="myModalAddress" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<label>新收货地址：</label>  
							<textarea rows="5" cols="60" id="newAddress"></textarea>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default"
								data-dismiss="modal">关闭</button>
...
<script src="plus/H+/js/bootstrap.min.js"></script>
	...
	<script type="text/javascript"
		src="JspJsCss/managerJsp/js/scoreOrderTablePage.js"></script>
	<script type="text/javascript">
