...
<body >
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<input type="hidden" value="${categoryVo. returnFlag}"
				id="returnFlag">
							...
							<div class="ibox-content">
								<div class="table-responsive">
									<div class="modal-body">
										...
										<input type="hidden" class="form-control" width="220px"
											placeholder="请输入层级" id="lever" />


									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-primary"
											onclick="addCatagory()">提交更改</button>
									</div>
								</div>
							</div>
						</div>
