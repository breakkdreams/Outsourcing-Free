			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-4">
					<ol class="breadcrumb">
						...
						<li class="active"><strong>商品评价管理</strong></li>
					</ol>
				</div>
			</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<table style="width: 100%;">
								<tr>
									<td>回复内容: <input class="form-control" id="replyContent"/></td>
								</tr>
							</table>
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary"
									onclick="subComment()">提交更改</button>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="JspJsCss/managerJsp/js/goodsComment.js"></script>
